...
def do_offer(self, args):
    ...
    def do_create_bug(self,args):
        try:
            ...
            print 'try example: create_bug {user_name} {passoword} CS bug.txt' \
                'or try example: create_bug {user_name} {passoword} ISSUERPTS bug.txt'
...
def do_create_story(self,args):
    try:
        ...
        print 'try example: create_story {user_name} {passoword} story.txt'
